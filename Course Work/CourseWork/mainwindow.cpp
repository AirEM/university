...
void MainWindow::on_loadPushButton_clicked()
{
    ...
    // Еще сферы
    command::AddSphereCommand command_1(-1.0, -1.5, -12, 2, red_rubber);
    ...
    command::AddLightCommand command_l(-20, 20,  20, 1.5);
    _facede->execute(&command_l);

    command::AddLightCommand command_l1(30, 50, -25, 1.8);
    _facede->execute(&command_l1);

    command::AddLightCommand command_l2(30, 20,  30, 1.7);
